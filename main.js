...
*/
  ...
  var $author$project$Main$debugLog = $elm$core$Debug$log;
  var $author$project$Main$GroupA = { $: "GroupA" };
  var $author$project$Main$GroupB = { $: "GroupB" };
  ...
  var $elm$random$Random$float = F2(function (a, b) {
  ...
  var $elm$random$Random$getByWeight = F3(function (_v0, others, countdown) {
  ...
  var $elm$random$Random$weighted = F2(function (first, others) {
    ...
    var total =
      normalize(first) +
      $elm$core$List$sum(A2($elm$core$List$map, normalize, others));
    return A2(
  ...
  var $elm$random$Random$uniform = F2(function (value, valueList) {
    return A2(
  ...
  var $author$project$Main$fontGroupGenerator = A2(
    $elm$random$Random$uniform,
    $author$project$Main$GroupA,
    _List_fromArray([$author$project$Main$GroupB])
  );
  ...
  var $author$project$Main$init = function (_v0) {
    ...
    var _v1 = A2(
      ...
      $author$project$Main$fontGroupGenerator,
      seed
    );
    var randomGroup = _v1.a;
    var _v2 = A2($elm$core$Debug$log, "init", "load2");
    return _Utils_Tuple2(
      {
        direction: $author$project$Main$North,
        fontGroup: randomGroup,
        x: 2,
        y: 2,
      },
      A2(
        $author$project$Main$debugLog,
        "Elm app initialized",
  ...
  var $author$project$Main$moveForward = function (model) {
    ...
    switch (_v0.$) {
      case "North":
        return model.y > 0 ? _Utils_update(model, { y: model.y - 1 }) : model;
      case "South":
        return model.y < 4 ? _Utils_update(model, { y: model.y + 1 }) : model;
      case "East":
        return model.x < 4 ? _Utils_update(model, { x: model.x + 1 }) : model;
      default:
        return model.x > 0 ? _Utils_update(model, { x: model.x - 1 }) : model;
    }
  };
  ...
  var $author$project$Main$update = F2(function (msg, model) {
    switch (msg.$) {
      case "MoveForward":
        return _Utils_Tuple2(
          $author$project$Main$moveForward(model),
          $elm$core$Platform$Cmd$none
        );
      case "RotateLeft":
        return _Utils_Tuple2(
  ...
  var $author$project$Main$fontClass = function (group) {
    if (group.$ === "GroupA") {
      return "group-a-font";
    } else {
      return "group-b-font";
  ...
  var $author$project$Main$gridRepresentation = function (model) {
    return (
      "Robot is at (" +
      ($elm$core$String$fromInt(model.x) +
        (", " +
          ($elm$core$String$fromInt(model.y) +
            (") facing " +
              $author$project$Main$directionToString(model.direction)))))
    );
  };
  ...
  var $author$project$Main$view = function (model) {
    var _v0 = A2($elm$core$Debug$log, "View Function called", model);
    return A2(
      $elm$html$Html$div,
      _List_fromArray([
        $elm$html$Html$Attributes$class(
          "grid-container " + $author$project$Main$fontClass(model.fontGroup)
        ),
      ]),
      _List_fromArray([
        A2(
          $elm$html$Html$div,
          _List_fromArray([$elm$html$Html$Attributes$class("grid")]),
          _List_fromArray([
            $elm$html$Html$text($author$project$Main$gridRepresentation(model)),
          ])
        ),
        A2(
          $elm$html$Html$div,
          _List_fromArray([$elm$html$Html$Attributes$class("controls")]),
          _List_fromArray([
            A2(
              ...
              _List_fromArray([$elm$html$Html$text("Rotate Left")])
            ),
            A2(
              $elm$html$Html$button,
              _List_fromArray([
              ...
              _List_fromArray([$elm$html$Html$text("Move Forward")])
            ),
            A2(
              $elm$html$Html$button,
              _List_fromArray([
              ...
              _List_fromArray([$elm$html$Html$text("Rotate Right")])
            ),
          ])
        ),
      ])
